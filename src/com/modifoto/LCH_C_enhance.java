			...
			for ( int y = 0; y < height; ++y )
			{
				...
				for ( int yi = yMin; yi < yMax; ++yi )
					for ( int xi = xMin0; xi < xMax0; ++xi )
						++hist[ roundPositive( C[xi][yi] / 128.0f * bins ) ];
				...
				for ( int x = 0; x < width; ++x )
				{
					...
					final int v = (int)roundPositive( C[x][y] / 128.0f * bins );
					...
					if ( xMin > 0 )
					{
						...
						for ( int yi = yMin; yi < yMax; ++yi )
						{    
							C[xMin1][yi] = (C[xMin1][yi] > 100 ? 100 : (C[xMin1][yi] < 0 ? 0 :C[xMin1][yi] ));
							--hist[ (int) (roundPositive( C[xMin1][yi] / 128.0f * bins) ) ];		
						}
					}
					...
					if ( xMax <= bitmap.getWidth() )
					{
						...
						for ( int yi = yMin; yi < yMax; ++yi )
						{
							C[xMax1][yi] = (C[xMax1][yi] > 100 ? 100 : (C[xMax1][yi] < 0 ? 0 :C[xMax1][yi] ));
							++hist[ (int) (roundPositive( C[xMax1][yi] / 128.0f * bins) ) ];
						}
					}
		        	...
		        	C[x][y] = (int) (( cdf - cdfMin )/(denominator)* 128.0f);
